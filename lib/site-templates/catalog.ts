...
export const siteTemplates: SiteTemplate[] = [
  ...
  {key:"inmobiliaria-a",name:"Inmobiliaria",businessType:"real_estate",description:"Propiedades, asesores, interesados y solicitudes de visita.",previewPath:"/templates/inmobiliaria-a/index.html",configPath:"/templates/inmobiliaria-a/site-config.js",modules:["properties","inquiries","visits","widget"],editableAreas:["brand","hero","properties","contact","integrations"]},
