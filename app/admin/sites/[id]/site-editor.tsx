...
type Tab = "design" | "content" | "menu" | "properties" | "location" | "integrations" | "history";
...
export default function SiteEditor({ id }: { id: string }) {
  ...
  const tabs: [Tab, string][] = [["design", "Diseño"], ["content", "Contenido"], ...(isRealEstate ? [["properties", "Catálogo"] as [Tab, string]] : [["menu", "Menú"] as [Tab, string]]), ["location", "Ubicación"], ["integrations", "CRM y chatbox"], ["history", "Publicación"]];
