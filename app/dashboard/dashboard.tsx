...
export default function Dashboard() {
  ...
  const labels: Record<string, string> = { inicio: `${greeting}, ${account.name.split(" ")[0]}`, conversaciones: "Conversaciones", inmobiliaria: "Gestión inmobiliaria", contactos: "Contactos", pipeline: "Pipeline comercial", equipo: "Equipo", automatizaciones: "Automatizaciones", reportes: "Reportes", auditoria: "Auditoría", configuracion: "Configuración" };
