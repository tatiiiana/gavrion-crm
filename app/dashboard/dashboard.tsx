...
export default function Dashboard() {
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      {view === "campos" && tenantId && <CustomFields tenantId={tenantId} />}
